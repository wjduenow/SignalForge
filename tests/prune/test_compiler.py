...
def test_compile_ingested_custom_sql_comment_bearing_body_not_false_rejected() -> None:
    """DEC-013: a compiled body carrying dbt's -- line comments and /* */ block
    comments is NOT false-rejected (the #116 validate_test_sql would reject
    both wholesale). The comment-tolerant validate_ingested_sql strips them,
    so the body compiles and is returned unchanged."""
    body = (
